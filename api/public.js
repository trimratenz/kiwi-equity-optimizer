...
export function buildLeadSheetRecord(body, contact, consent, summary, deviceTypeValue = "desktop") {
  ...
  return {
    session_id: cleanText(body.session_id || body.sessionId, 120), visitor_id: cleanText(body.visitor_id || body.visitorId, 120), page_path: cleanText(body.page_path || body.path, 250) || "/", device_type: deviceTypeValue,
